...
<div class="flex-1 p:2 sm:p-6 justify-between flex flex-col h-screen">
    <div class="flex sm:items-center justify-between py-3 border-b-2 border-gray-200">
       <div class="relative flex items-center space-x-4">
          ...
          <img src="{{ asset('assets/img/2.jpg') }}" alt="" class="w-10 sm:w-16 h-10 sm:h-16 rounded-full">
          </div>
       ...
       <!-- Him/Her -->
        <div class="chat-message">
          <div class="flex items-end">
             ...
             <img src="{{ asset('assets/img/2.jpg') }}" alt="My profile" class="w-6 h-6 rounded-full order-1">
          </div>
       </div>
       <!-- Me -->
       <div class="chat-message">
          <div class="flex items-end justify-end">
             ...
             <img src="{{ asset('assets/img/1.jpg') }}" alt="My profile" class="w-6 h-6 rounded-full order-2">
          </div>
       </div>
    </div>
    <div class="border-t-2 border-gray-200 px-4 pt-4 mb-2 sm:mb-0">
       <div class="relative flex">
          ...
          <div class="absolute right-0 items-center inset-y-0 hidden sm:flex">
             ...
             <button id="submitButton" type="button" class="inline-flex items-center justify-center rounded-lg px-4 py-3 transition duration-500 ease-in-out text-white bg-blue-500 hover:bg-blue-400 focus:outline-none">
